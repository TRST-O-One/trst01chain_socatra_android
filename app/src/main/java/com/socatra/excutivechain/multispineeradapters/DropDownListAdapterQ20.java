...
public class DropDownListAdapterQ20 extends BaseAdapter {
	...
	public void setSelected(String selected) {
		DropDownListAdapterQ20.selected = selected;
	}

	public DropDownListAdapterQ20(Context context, ArrayList<String> items,
                                  TextView tv) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if(RiskAssessmentActivity.checkSelected20[position])
	...
	private void setText(int position1){
		if (!RiskAssessmentActivity.checkSelected20[position1]) {
			RiskAssessmentActivity.checkSelected20[position1] = true;
			selectedCount++;
		} else {
			RiskAssessmentActivity.checkSelected20[position1] = false;
			selectedCount--;
		}
		...
		if (selectedCount == 0) {
			...
			for (int i = 0; i < RiskAssessmentActivity.checkSelected20.length; i++) {
				if (RiskAssessmentActivity.checkSelected20[i] == true) {
			...
			for (int i = 0; i < RiskAssessmentActivity.checkSelected20.length; i++) {
				if (RiskAssessmentActivity.checkSelected20[i]) {
