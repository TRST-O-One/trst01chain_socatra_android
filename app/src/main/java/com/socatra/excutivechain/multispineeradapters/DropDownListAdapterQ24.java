...
public class DropDownListAdapterQ24 extends BaseAdapter {
	...
	public void setSelected(String selected) {
		DropDownListAdapterQ24.selected = selected;
	}

	public DropDownListAdapterQ24(Context context, ArrayList<String> items,
                                  TextView tv) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if(RiskAssessmentActivity.checkSelected24[position])
	...
	private void setText(int position1){
		if (!RiskAssessmentActivity.checkSelected24[position1]) {
			RiskAssessmentActivity.checkSelected24[position1] = true;
			selectedCount++;
		} else {
			RiskAssessmentActivity.checkSelected24[position1] = false;
			selectedCount--;
		}
		...
		if (selectedCount == 0) {
			...
			for (int i = 0; i < RiskAssessmentActivity.checkSelected24.length; i++) {
				if (RiskAssessmentActivity.checkSelected24[i] == true) {
			...
			for (int i = 0; i < RiskAssessmentActivity.checkSelected24.length; i++) {
				if (RiskAssessmentActivity.checkSelected24[i]) {
