...
public class AppConstant {
    ...
    public static final String DeviceDealerID = "DEVICEDEALER ID";
    public static final String DeviceDealerName = "DeviceDealerName";
    public static final String DeviceProcessorName = "DeviceProcessorName";
    public static final String DeviceTraderName = "DeviceTraderName";
    public static final String DeviceCustomerName = "DeviceCustomerName";
    public static final String DeviceDealerAddress = "DeviceDealerAddress";


    //DB
    public static final String DeviceProcessorAddress = "DeviceProcessorAddress";
    public static final String DeviceTraderAddress = "DeviceTraderAddress";
    public static final String DeviceCustomerAddress = "DeviceCustomerAddress";
    public static final String DeviceCustomerId = "DEVICECUSTOMER ID";
    public static final String CustomerID = "Customer ID";
    public static final String DeviceProcessorId = "DEVICEMANUFACTURE ID";
    public static final String DeviceTraderId = "DEVICETRADER ID";
    public static final String DeviceUserRole = "DEVICEUSER ROLE";

    public static final String DeviceLanguageID = "DEVICE LANGUAGEID";

    public static final String DeviceLanguageName = "DEVICE LANGUAGEName";
    ...
    public static final String DATE_FORMAT_DD_MM_YYYY2 = "dd-MM-yyyy HH:mm:ss";
    public static final String DATE_FORMAT_YYYY_MM_DD = "yyyy-MM-dd";
    public static final String DATE_FORMAT_YYYYMMDD_HHMMSS = "yyyyMMddHHmmss";
    ...
    // TODO: 11/22/2023 live url
  // public static String BASE_AUTH_URL = "https://gajahruku.trst01.com/api/M1/"; //Live url
    // TODO: For Dev URL
    public static String BASE_AUTH_URL = "http://4.240.93.105/gajahrukuapi/M1/";// dev

    public static String App_PackageName = "com.trst01.intellitrack";
    ...
    public static String DB_NAME = "Intellitrack.db";
    public static String APP_FOLDER = "IntelliTrack";
    public static String DB_FOLDER = "Intellitrack_DB";
    public static String APP_ENVIRONMENT = "Intellitrack_Prod_DB";//DEV sub folder for db
    public static final String DB_SUB_FOLDER = APP_ENVIRONMENT;
    public static String AUTHORIZATION_TOKEN_KEY = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6MywiaWF0IjoxNjQxODIwNTkyLCJleHAiOjE2NDE5MDY5OTJ9.mf8q4XNoaxzwYIm73vRgdXznrsdZRjJS3-z5lznXNFg";// TODO: RAW DATA URL
    public static String IsFirstTimeLogin = "first";
