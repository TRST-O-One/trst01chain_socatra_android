...
public class DropDownListAdapterQ10 extends BaseAdapter {
	...
	public void setSelected(String selected) {
		DropDownListAdapterQ10.selected = selected;
	}

	public DropDownListAdapterQ10(Context context, ArrayList<String> items,
                                  TextView tv) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if(RiskAssessmentActivity.checkSelected10[position])
	...
	private void setText(int position1){
		if (!RiskAssessmentActivity.checkSelected10[position1]) {
			RiskAssessmentActivity.checkSelected10[position1] = true;
			selectedCount++;
		} else {
			RiskAssessmentActivity.checkSelected10[position1] = false;
			selectedCount--;
		}
